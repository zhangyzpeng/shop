<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wamp\www\shop\public/../application/admin\view\image\edit.html";i:1545984592;s:56:"D:\wamp\www\shop\application\admin\view\public\base.html";i:1545993573;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel margin-top" id="add">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/admin/image/<?php echo $data['id']; ?>">
      ...
      <div class="form-group">
          ...
          <div class="field">
            <select name="type" class="input w50">
              ...
              <option <?php echo $data['type']==1?'selected':''; ?> value="1">Logo(280*112)</option>
              <option <?php echo $data['type']==2?'selected':''; ?> value="2">幻灯片(960*550)</option>
            </select>
            <div class="tips"></div>
          </div>
        </div>
         ...
         <!--dom结构部分-->
            <div id="uploader-demo">
                ...
                <span id="tip" style="position: absolute; margin-left: 200px; margin-top: -50px;">
                  <img style="width:200px; height: 50px;" src="\<?php echo $data['img_url']; ?>">
