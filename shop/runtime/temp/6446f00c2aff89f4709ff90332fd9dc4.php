<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wamp\www\shop\public/../application/admin\view\goods\list.html";i:1546753019;s:56:"D:\wamp\www\shop\application\admin\view\public\base.html";i:1545993573;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <table class="table table-hover text-center">
      ...
      <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
        <tr>
          ...
          <td><div class="button-group"> <a class="button border-main" href="/admin/goods/<?php echo $val['id']; ?>/edit"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 下架</a> </div></td>
        </tr>
