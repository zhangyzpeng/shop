  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/admin/goods"> 
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="origin_price" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="goods_type" placeholder="商品型号请用 | 隔开" />
        </div>
      </div>
