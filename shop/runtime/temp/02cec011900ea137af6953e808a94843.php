<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp\www\shop\public/../application/home\view\user\register.html";i:1546245197;s:57:"D:\wamp\www\shop\application\home\view\public\header.html";i:1545994529;}*/ ?>
<html>
 <head> 
  <meta charset="UTF-8" /> 
    ...
    <div class="content clearfix" style="background:url(/static/home/images/login.jpg) no-repeat center center;"> 
     ...
     <div class="lg_left ui-option-main-box" id="lg_content"> 
      ...
      <div class="login_mod_tab"> 
       <div class="fl mod"> 
        <a class="lo_mod tab_on" lo-mod="normal" href="javascript:;" title="普通登入">注册</a> 
       </div> 
        ...
        <form id='form' method="post" action="/user/register"> 
         ...
         <div class="mod_box lo_mod_box" data-isshow="0"> 
          <div class="ui-sign-item ui-name-item lg_item lg_name"> 
           <input maxlength="32" class="ui-input pwd_text" ajaxurl="/user/check_user" datatype="e" name="email" id='email' placeholder="邮箱" style="border-color:#CFCFCF;" type="text" />
          </div> 
          <div class="ui-sign-item ui-sign-common-item lg_item lg_pass"> 
           <input maxlength="32" class="ui-input pwd_text" datatype="s6-10" name="password" value="" placeholder="密码" style="border-color:#CFCFCF;" type="password" /> 
            ...
            <input maxlength="32" class="ui-input pwd_text width_180" name="telcode" datatype="s4-4" placeholder="动态码" style="border-color:#CFCFCF;" type="text" /> 
           </div> 		  
         </div> 
